        ...
        <div>
            ...
            <nav className="navbar navbar-expand-lg navbar-white bg-white shadow-sm sticky-top">
                <div className="container">
                    {/* Changed: text-warning to text-primary */}
                        ...
                        <ul className="navbar-nav ms-auto align-items-lg-center">
                            ...
                            <li className="nav-item mx-2">
                                ...
                                >
                                    ...
                                    {cartCount > 0 && (
                                        <span
                                            // Changed: bg-warning to bg-primary, text-dark to text-white for better contrast
                            ...
                            {!isUser && (
                                <>
                                    <li className="nav-item mx-2">
                                        <NavLink
                                            to="/signin"
                                            // Changed: Replaced classes to be a visible blue outline button
                                    ...
                                    <li className="nav-item mx-2">
                                        <NavLink
                                            ...
                                            className={({ isActive }) =>
                                               ...
                                               ' btn btn-primary btn-sm ${isActive ? "fw-bold shadow" : ""}'
                                            }
                                        >
